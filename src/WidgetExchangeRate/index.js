...
function WidgetExchangeRate() {
  ...
  return (
    <div className="WidgetExchangeRate">
      <h5 className="WidgetExchangeRate__title">Tipo de cambio</h5>
      {!loading && <div className="WidgetExchangeRate__body">$1 MXN = ${Number(dolar).toFixed(2)} USD</div>}
    </div>
  );
}
